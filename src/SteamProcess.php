...
class SteamProcess
{
    ...
    public function __construct(CacheManager $manager)
    {
        ...
        $this->cacheTag = Config::get('steam-prices.cache_tag', 'steam.prices');
        $this->cacheTime = Config::get('steam-prices.cache_time', 60);
        $this->language = Config::get('steam-prices.language', 'english');
     ...
     * @return SteamProcess
     */
    public function loadInventory($steamId, $appId = 730, $contextId = 2): SteamProcess
    {
